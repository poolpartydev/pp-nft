...
interface PresaleExclusiveInterface extends ethers.utils.Interface {
  functions: {
    ...
    "pinksalePresaleAddress()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "pinksalePresaleAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class PresaleExclusive extends BaseContract {
  ...
  interface: PresaleExclusiveInterface;
  ...
  functions: {
    ...
    pinksalePresaleAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  isEligible(_purchaser: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    pinksalePresaleAddress(overrides?: CallOverrides): Promise<BigNumber>;
